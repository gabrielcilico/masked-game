...
class DefaultTheme {
  ...
  static inputDecoration() {
    return InputDecorationTheme(
      ...
      filled: true,
      labelStyle: inputDecorationLabelTextTheme(
          color: Palette.labelColor, size: 14, fontWeight: FontWeight.w500),
      errorMaxLines: 2,
      suffixIconColor: Palette.iconInputColor,
      prefixIconColor: Palette.iconInputColor,
      hintStyle:
          inputDecorationLabelTextTheme(size: 14, color: Palette.textColor),
      ...
      enabledBorder:
          inputDecorationBorderStyle(color: Palette.inputBorderColor),
  ...
  static inputDecorationLabelTextTheme(
      {color, double size = 14, bool bold = false, FontWeight? fontWeight}) {
    return TextStyle(
      color: color,
      fontSize: size,
